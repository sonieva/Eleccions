...
-- -----------------------------------------------------
-- Schema Grup2_eleccions
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema Grup2_eleccions
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `Grup2_eleccions` DEFAULT CHARACTER SET utf8 ;
USE `Grup2_eleccions` ;

-- -----------------------------------------------------
-- Table `Grup2_eleccions`.`comunitats_autonomes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Grup2_eleccions`.`comunitats_autonomes` (
...
-- -----------------------------------------------------
-- Table `Grup2_eleccions`.`provincies`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Grup2_eleccions`.`provincies` (
  ...
  CONSTRAINT `fk_provincies_comunitats_autonomes`
    ...
    REFERENCES `Grup2_eleccions`.`comunitats_autonomes` (`comunitat_aut_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Grup2_eleccions`.`municipis`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Grup2_eleccions`.`municipis` (
  ...
  CONSTRAINT `fk_municipis_provincies`
    ...
    REFERENCES `Grup2_eleccions`.`provincies` (`provincia_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Grup2_eleccions`.`eleccions`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `Grup2_eleccions`.`eleccions_municipis`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Grup2_eleccions`.`eleccions_municipis` (
  ...
  CONSTRAINT `fk_eleccions_municipis_municipis`
    ...
    REFERENCES `Grup2_eleccions`.`municipis` (`municipi_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_eleccions_municipis_eleccions`
    FOREIGN KEY (`eleccio_id`)
    REFERENCES `Grup2_eleccions`.`eleccions` (`eleccio_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Grup2_eleccions`.`candidatures`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Grup2_eleccions`.`candidatures` (
...
-- -----------------------------------------------------
-- Table `Grup2_eleccions`.`persones`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Grup2_eleccions`.`persones` (
...
-- -----------------------------------------------------
-- Table `Grup2_eleccions`.`candidats`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Grup2_eleccions`.`candidats` (
  ...
  CONSTRAINT `fk_candidats_persones1`
    ...
    REFERENCES `Grup2_eleccions`.`persones` (`persona_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_candidats_candidatures1`
    FOREIGN KEY (`candidatura_id`)
    REFERENCES `Grup2_eleccions`.`candidatures` (`candidatura_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Grup2_eleccions`.`vots_candidatures_mun`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Grup2_eleccions`.`vots_candidatures_mun` (
  `eleccio_id` TINYINT UNSIGNED NOT NULL,
  `municipi_id` SMALLINT UNSIGNED NOT NULL,
  `candidatura_id` INT UNSIGNED NOT NULL,
  ...
  CONSTRAINT `fk_candidatures_municipis_eleccions_municipis1`
    ...
    REFERENCES `Grup2_eleccions`.`eleccions_municipis` (`eleccio_id` , `municipi_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Grup2_eleccions`.`vots_candidatures_prov`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Grup2_eleccions`.`vots_candidatures_prov` (
  `provincia_id` TINYINT UNSIGNED NOT NULL,
  `candidatura_id` INT UNSIGNED NOT NULL,
  `vots` INT UNSIGNED NULL COMMENT 'Número de vots obtinguts per la candidatura',
...
-- -----------------------------------------------------
-- Table `Grup2_eleccions`.`vots_candidatures_ca`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Grup2_eleccions`.`vots_candidatures_ca` (
